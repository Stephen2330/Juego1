...
public class Tortuga extends Animal{
    ...
    public void cambiaPosicion() {
        ...
        if (valorAvance <= 50) {
            ...
            rellenaArreglo();
            System.out.println(toString()); System.out.println(nombreJugador + ": Avance Rapido \n");
        ...
        if(valorAvance > 50 && valorAvance <= 70){
            ...
            setPosicion(nuevaPosicion);
            rellenaArreglo();
            System.out.println(toString()); System.out.println(nombreJugador + ": Resbalon \n");
        ...
        if (valorAvance > 70 && valorAvance <= 100) {
            ...
            System.out.println(nombreJugador + ": Avance Lento \n");
    ...
    public Tortuga(int posicion, boolean ganador) {
